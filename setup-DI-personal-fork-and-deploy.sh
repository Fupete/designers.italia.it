...
echo "7. Prepare GitHub Pages: create gh-pages branch and run 'Prepare deploy' workflow; enable GitHub Pages build from that branch gh-pages and you will see the readme live" 
...
echo ""
echo "Script version: 1.0.0-alpha.2 - September 4th, 2025"
echo ""
