...
echo "7. Prepare deploy: (a) Enable Github Pages Deploy from Actions (b) Create gh-pages branch (c) Launch 'Prepare Deploy' workflow (d) Switch GitHub Pages Deploy from branch gh-pages, ..."
echo "8. Deploy DI fork/mirror: go to GitHub Actions tab and run 'Deploy' workflow"
echo ""
